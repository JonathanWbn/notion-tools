...
import { addToolToUser, useDatabases, useTools, useUser } from '../../infrastructure/api-client'
      ...
      <div className="max-w-2xl w-full">
        ...
        <ul className="list-disc pl-6">
          {user?.toolConfigs.map((config) => {
            ...
            if (!tool) return null
            const details = [
              databases?.find((db) => db.id === config.settings.databaseId)?.title[0].plain_text,
        ...
        <div className="flex items-center justify-around">
          ...
          >
            <span className="border-b border-darkRed text-current font-medium">Delete account</span>
          </button>
          <a
